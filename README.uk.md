...
Цей репозиторій містить спеціалізований скіл (skill) для ШІ-агентів. Він допомагає агенту надавати експертну допомогу у написанні Python-коду, парсингу URL та інтеграції цієї бібліотеки у ваші проєкти.
